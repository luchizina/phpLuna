<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-05-20 00:12:25
         compiled from "vistas\propuestas_listado.tpl" */ ?>
<?php /*%%SmartyHeaderCode:983693975ce2164deba5e0-20207774%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '983693975ce2164deba5e0-20207774',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5ce2164e189319_39739412',
  'variables' => 
  array (
    'url_base' => 0,
    'proyecto' => 0,
...
<?php if ($_valid && !is_callable('content_5ce2164e189319_39739412')) {function content_5ce2164e189319_39739412($_smarty_tpl) {?>
<!DOCTYPE html>
<html lang="es">
  <head>
                  ...
                  <tr>
                   ...
                   <td><?php echo $_smarty_tpl->tpl_vars['prop']->value->getMonto();?>
                    ...
                    <td>
                      ...
                      <input type="button" value="Ver detalle" class="btn btn-success" onClick="window.location='<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
...
/'"/>
                       ...
                       <input type="button" value="Desfavoritear" id="desfavoritear" class="btn btn-danger" onClick="window.location='<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
propuesta/desfavoritear/<?php echo $_smarty_tpl->tpl_vars['prop']->value->getNombre();?>
/'"/>
                       <?php }?>
                       <?php if (!$_smarty_tpl->tpl_vars['prop']->value->isFavoriteada($_smarty_tpl->tpl_vars['usuLogNick']->value)) {?>
                       <input type="button" value="Favoritear" id="Favoritear" class="btn btn-success" onClick="window.location='<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
