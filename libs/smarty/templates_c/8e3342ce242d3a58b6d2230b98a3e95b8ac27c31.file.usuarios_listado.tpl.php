<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-04-30 01:12:53
         compiled from "vistas\usuarios_listado.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6198675605ca2ae94f0c703-59793622%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e3342ce242d3a58b6d2230b98a3e95b8ac27c31' => 
    array (
  ...
  'nocache_hash' => '6198675605ca2ae94f0c703-59793622',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5ca2ae951eea09_53063932',
  'variables' => 
  array (
    'url_base' => 0,
    'proyecto' => 0,
...
<?php if ($_valid && !is_callable('content_5ca2ae951eea09_53063932')) {function content_5ca2ae951eea09_53063932($_smarty_tpl) {?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
/'"/>
                     ...
                     <input type="button" value="modificar" class="btn btn-submit" onClick="window.location='<?php echo $_smarty_tpl->tpl_vars['usuario_modifica']->value;
echo $_smarty_tpl->tpl_vars['persona']->value->getId();?>
/'"/>

                      <input type="button" value="Favoritos" class="btn btn-submit" onClick="cargarFavoritos();"/>

                      <span class="glyphicon glyphicon-star-empty" onClick="javascript:AgregaFavoritos(<?php echo $_smarty_tpl->tpl_vars['persona']->value->getId();?>
);" id="<?php echo $_smarty_tpl->tpl_vars['persona']->value->getId();?>
"></span>
                    </td>
                  </tr>
                <?php } ?>
